...
public final class Endpoints {
  ...
  public static String buildURIForTopTracks(String shortTerm) {
    final String TracksTimeRange =
        shortTerm.equalsIgnoreCase("1") ? TimeRange.SHORT_TERM.getTimeRange()
            : TimeRange.MEDIUM_TERM.getTimeRange();
  ...
  public static String buildURIToReplaceOldSongs(String userId, String playlistId) {
    return new StringBuilder()
        .append(BASE_URL)
        .append(REPLACE_SONGS_IN_PLAYLIST_EP.replace(USER_ID_PLACEHOLDER, userId)
  ...
  public static String buildURIToAddNewSongs(String userId, String playlistId) {
    return new StringBuilder()
        .append(BASE_URL)
        .append(ADD_SONGS_IN_PLAYLIST_EP.replace(USER_ID_PLACEHOLDER, userId)
            .replace("{playlistId}", playlistId))
        .toString();
  }
